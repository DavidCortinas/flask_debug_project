...
class ScriptDirectory(object):
    ...
    def _generate_(self, src, dest, **kw):
        util.status(
    ...
    def generate_revision(
        ...
        **kw
        ...
        This runs the ``script.py.mako`` , given
         arguments, and creates a new file.
